...
int main(void)
{
    ...
    double G = 6.67 * 10e-11;  /* universal constant of grsvitstion */
    double F;  /* for storing gravitational force of atttaction */
    ...
    F = (G * m1 * m2) / (r * r);
    printf("Gravitstional force of attraction = %lf Newton\n", F);
